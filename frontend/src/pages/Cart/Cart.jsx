...
const Cart = () => {
  ...
  for (const item in cartItems)
  {
    totalItemInCart += cartItems[item];
  } 
  if (totalItemInCart > 0){
    ...
    return(
      <div className='cartifempty'>
      <div className='emptycart'style={{ backgroundImage: `url(${assets.cart_empty})`, backgroundSize : 'contain', backgroundRepeat:'no-repeat', backgroundPosition:'center'}}>
        <p>the cart is empty please add item to continue</p>
      </div>
      </div>
    );
  }
